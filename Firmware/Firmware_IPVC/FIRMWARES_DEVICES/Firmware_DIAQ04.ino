...
/*  LoRaWAN */
    ...
    // Chaves referentes ao Device - DIAQ04

    static const PROGMEM u1_t NWKSKEY[16] = { 0x8c, 0x9d, 0x10, 0xc0, 0x2c, 0x28, 0xdd, 0xd2, 0xdc, 0x21, 0x7d, 0x4a, 0x69, 0xad, 0xf0, 0xe7 };
    static const u1_t PROGMEM APPSKEY[16] = { 0xcf, 0xc0, 0x21, 0x2c, 0x4f, 0x5e, 0x5c, 0x2e, 0x17, 0x0f, 0xd4, 0x4e, 0x1e, 0x99, 0xf4, 0xc7 };
    static const u4_t DEVADDR = 0x0532cdb2;
...
void CreateDados()
{
    ...
    */
    ...
    if(error_dht != 0)
    {
      String ED;
      ED = String(error_dht);
      dados += ("&ErDht="); dados += (ED);   // Erro do dht22 
    }
    ...
    if(error_sps != 0)
    {
      String ES;
      ES = String(error_sps);
      dados += ("&ErSps="); dados += (ES);   // Erro do SPS30
    } 
    ...
    {
      String ESG;
      ESG = String(error_sgp);
      dados += ("&ErSgp="); dados += (ESG);   // Erro do SGP30 
    }
}
